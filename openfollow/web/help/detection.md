...
- **Track** – which part of the bounding box gives the marker position: **Head (top of person)** or **Feet (floor position)**. Choose whichever the show geometry references.
