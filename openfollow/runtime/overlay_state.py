...
class OverlayState:
    ...
    error_message: str = ""
    # What stopped the feed, and the operator sentence for it. The sentence is
    # what the web UI leads with, so the device says the same thing rather than
    # only the element's wording.
    video_failure: str = "none"
