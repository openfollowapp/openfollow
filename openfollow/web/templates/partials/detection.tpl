...
<div id="detection-section" class="experimental-feature detection-cards {{'saved' if saved_section else ''}}">
    ...
    <div class="detection-intro">
        ...
        <span class="section-note">{{_('Optional YOLO person detection. Compute-heavy – a workstation is recommended over a Pi 5; see each box\'s help. Each box saves on its own.')}}</span>
    </div>
...
%     else:
                    ...
                    <span class="field-note">{{_('No models installed yet – download one below.')}}</span>
%     end
                </div>
            </div>
%     if storage_info:
